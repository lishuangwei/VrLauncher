...
@SuppressLint("NewApi")
public class HidInputUtil {
	
	protected String TAG = "HidInputUtil";
	Context context;
	private BluetoothAdapter mBtAdapter;
	private static HidInputUtil instance;
	private BluetoothProfile mBluetoothProfile;
	private int INPUT_DEVICE = 4;
	public static HidInputUtil getInstance(Context context){
		if(null == instance){
			instance = new HidInputUtil(context);
		}
		return instance;
	}

	public HidInputUtil(Context context) {
