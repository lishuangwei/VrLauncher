...
public class TimeZoneUtil
{
    ...
    public static void main(String[] args)
    {
        ...
        Map<String, String> list = getZoneList();
        //原时区的时间
    ...
    public static Map<String, String> getZoneList()
    {
        ...
        {
            //获取给定 ID 的 TimeZone
            timeZone = java.util.TimeZone.getTimeZone(zoneIds[i]);
...
//            map.put(zoneIds[i], diplayOffset);
            map.put(diplayOffset, zoneIds[i]);
        }
        return map;
    }

    public static String getTimeZone(String timeZone){
        Map<String, String> zoneMap = getZoneList();
        return zoneMap.get(timeZone);
    }
                                     ...
                                     String targetId)
    {
        ...
        try
        {
            ...
            java.util.TimeZone sourceTimeZone = java.util.TimeZone.getTimeZone(sourceId);
            ...
            java.util.TimeZone targetTimeZone = java.util.TimeZone.getTimeZone(targetId);
