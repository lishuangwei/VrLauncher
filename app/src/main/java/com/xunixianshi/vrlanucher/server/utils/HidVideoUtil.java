...
@SuppressLint("NewApi")
public class HidVideoUtil {

	protected String TAG = "HidInputUtil";
	Context context;
	private BluetoothAdapter mBtAdapter;
	private static HidVideoUtil instance;
	private BluetoothProfile mBluetoothProfile;
	private int INPUT_DEVICE = 2;
	public static HidVideoUtil getInstance(Context context){
		if(null == instance){
			instance = new HidVideoUtil(context);
		}
		return instance;
	}

	public HidVideoUtil(Context context) {
